...
not_now = webdriver.find_element_by_css_selector("body > div.RnEpo.Yx5HN > div > div > div.mt3GC > button.aOOlW.bIiDR")
not_now.click()

# STEP TWO

hashtag_list = ['surf', 'roadtrip', 'golf', 'sunset', 'follow4follow']
...
for hashtag in hashtag_list:
    ...
    sleep(5)
    first_thumbnail = webdriver.find_element_by_xpath('//*[@id="react-root"]/section/main/article/div[1]/div/div/div['
                                                      '1]/div[1]/a/div/div[2]')
